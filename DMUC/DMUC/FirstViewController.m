...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
        PostCategory *cat = [[self fetchedResultsController] objectAtIndexPath:indexPath];
        MyLog(@"selected category: %@", cat);
    }
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"PostCategory" inManagedObjectContext:self.managedObjectContext];
